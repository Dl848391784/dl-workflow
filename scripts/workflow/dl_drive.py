    ...
    *,
    ...
    if prep:
        ...
        deliverable = (
            ...
            "   内容纪律（答题卡自包含，2026-09-18 用户实爆）：question/options "
            "引用任何编号/条目（如 R4、源单元名、前序结论编号）必须就地附原文摘要"
            "（如「R4（删除多余逻辑只保留等于1）」），禁裸引用——用户在卡片上看不到"
            "被引用的清单本体（req_items/技术方案 plan 完成前不可见），裸引用=无法作答\n"
